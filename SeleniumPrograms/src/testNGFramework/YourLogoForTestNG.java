...
public class YourLogoForTestNG {												//Dont need main method
		...
		@Test (priority =1)
		public void pageLoad() {												//creating methods. method name is our choice
		...
		//Registration
		@Test (priority =2)	
		public void initialRegistration() throws InterruptedException {			//creating methods. method name is our choice
		driver.findElement(By.xpath("//a[@class='login']")).click();
		driver.findElement(By.id("email_create")).sendKeys("hkhfenniy123@yopmail.com");
		Thread.sleep(2000);
		...
		@Test (priority =6)
		public void signIn() {
		driver.findElement(By.id("email")).sendKeys("hkhfenniy123@yopmail.com");
		driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
